...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "The Brand OS Intensive" },
      { name: "description", content: "Three hours at the IGNITE Center in Norcross, GA. Walk in respected. Walk out known." },
      { name: "author", content: "Adam Anderson" },
      { property: "og:title", content: "The Brand OS Intensive" },
      { property: "og:description", content: "Three hours at the IGNITE Center in Norcross, GA. Walk in respected. Walk out known." },
