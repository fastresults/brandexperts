...
export const BRIEF_SPINE: BriefSection[] = [
  ...
  { id: "non_negotiables", label: "Non-negotiables", hint: "Anything off-limits — topics, tones, platforms, or clients you won't touch." },
  { id: "workshop_alignment", label: "Workshop alignment", hint: "Of the 15 deliverables we'll build in the room, which 2–3 matter most to you?" },
];
